...
open class ImageSlideshow: UIView {
    ...
    required public init?(coder aDecoder: NSCoder) {
        ...
        initialize()
        setImageInputs(aDecoder.decodeObject(forKey: "images") as! [InputSource])
        setCurrentPage(aDecoder.decodeInteger(forKey: "page"), animated: false)
    }

    override open func encode(with aCoder: NSCoder) {
        super.encode(with: aCoder)
        aCoder.encode(self.images, forKey: "images")
        aCoder.encode(self.currentPage, forKey: "page")
    }
