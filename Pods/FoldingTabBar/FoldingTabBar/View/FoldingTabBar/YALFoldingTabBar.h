...
- (void)tabBarDidTouchDownExtraRightItem:(YALFoldingTabBar *)tabBar;
...
@property (nonatomic, strong, nullable) UIButton *centerButton;
...
@property (nonatomic, strong, nullable) UIButton *extraLeftButton;
@property (nonatomic, strong, nullable) UIButton *extraRightButton;
