...
extension TransitionDriver {
    ...
    func pushTransitionAnimationIndex(_ currentIndex: Int,
        ...
        copyView.cellIsOpen(true, animated: false)
        ...
        UIView.animate(withDuration: duration, delay: 0.0, options: UIViewAnimationOptions(), animations: {
            ...
            let headerView = copyView.copyCell()?.frontContainerView.viewWithTag(11)
    ...
    func popTransitionAnimationContantOffset(_ offset: CGFloat, backImage: UIImage?) {
        ...
        //configureCellBeforeClose(copyCell, offset: 0.0)
        ...
        DispatchQueue.main.asyncAfter(deadline: .now() + 0.016667) {
            self.closeBackViewConfigurationConstraints(copyCell)
            self.closeFrontViewConfigurationConstraints(copyCell)
            UIView.animate(withDuration: self.duration, delay: 0, options: UIViewAnimationOptions(), animations: {
...
extension TransitionDriver {
    ...
    fileprivate func configurateCell(_ cell: BasePageCollectionCell, backImage: UIImage?) {
        ...
        cell.widthAnchor.constraint(equalToConstant: cell.bounds.size.width).isActive = true
        cell.heightAnchor.constraint(equalToConstant: cell.bounds.size.height).isActive = true
        cell.centerXAnchor.constraint(equalTo: view.centerXAnchor).isActive = true
        cell.centerYAnchor.constraint(equalTo: view.centerYAnchor, constant: 0.0).isActive = true
